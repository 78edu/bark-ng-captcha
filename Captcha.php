...
$captcha_points=[random_point(),random_point(),random_point(),random_point()];
//$points_saved=$points;
//var_dump($points);
...
$captcha_answer1='';
$captcha_answer2='';
//var_dump($captcha_points);

foreach ($captcha_points as $v){
	if(($v[3])==1){
		$captcha_answer1.=chr($v[2]+48);
	}
}
$ca1=str_split($captcha_answer1);
//var_dump($ca1);
sort($ca1, SORT_NATURAL | SORT_FLAG_CASE);
//echo 'long';
//var_dump($ca1);

foreach ($captcha_points as $v){
	if(($v[3])==0){
		$captcha_answer2.=chr($v[2]+48);
	}
}
$ca2=str_split($captcha_answer2);
//var_dump($ca2);
sort($ca2, SORT_NATURAL | SORT_FLAG_CASE);
//echo 'short';
//var_dump($ca2);
...
$imageData2 = base64_encode($imageData);

return [$imageData2,$ca1,$ca2,$points];
}
